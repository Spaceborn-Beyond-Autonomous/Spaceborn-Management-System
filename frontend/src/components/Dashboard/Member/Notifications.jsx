// src/components/Dashboard/CEO/Notifications.js (and for other roles)
...
const Notifications = ({ userRole = 'CEO' }) => {
  ...
  const tabs = ['All', 'Meeting', 'Task', 'Resource', 'Project', 'System'];
  ...
  const loadMockData = () => {
    const mockNotifications = [
      { 
        ...
        description: 'A new meeting has been scheduled for the Engineering department.',
      ...
      { 
        id: 2, 
        title: 'Your task "Build login UI" is due in 2 days', 
        description: 'Please complete the task by the due date.',
      ...
      { 
        id: 3, 
        title: 'Your resource request "Software license" was rejected', 
        description: 'The resource request was rejected due to budget constraints.',
      ...
      { 
        id: 4, 
        title: 'You have been assigned "Email campaign" task', 
        description: 'A new task has been assigned to you.',
        time: '2026-06-06T11:00:00Z', 
        category: 'Task',
        read: false,
        priority: 'medium',
        actionUrl: '/tasks/4',
      ...
      { 
        id: 5, 
        title: 'All-Hands meeting link shared for June 10', 
        description: 'The meeting link for the All-Hands meeting is now available.',
        time: '2026-06-05T16:45:00Z', 
        category: 'Meeting',
        read: true,
        priority: 'low',
      ...
      { 
        id: 6, 
        title: 'New project "Mobile App Development" created', 
        description: 'You have been added to the Mobile App Development project.',
      ...
      {error && notifications.length === 0 ? (
        ...
        <div className="space-y-3">
          {notifications.map(notification => (
            <div 
              key={notification.id} 
              className={`bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition cursor-pointer ${getPriorityColor(notification.priority)} ${!notification.read ? 'bg-blue-50/30' : ''}`}
