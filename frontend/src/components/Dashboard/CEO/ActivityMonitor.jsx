...
const ActivityMonitor = ({ userRole = 'CEO' }) => {
  ...
  const getMockActivities = () => {
    return [
      ...
      { id: 3, type: 'meeting', name: 'Sita Krishnan', initials: 'SK', role: 'Team Lead', department: 'AI/LLM & Perception', action: 'scheduled meeting', details: 'Marketing Campaign Kickoff - Tomorrow at 10 AM', timestamp: new Date(Date.now() - 2 * 86400000).toISOString() },
      ...
      { id: 8, type: 'report', name: 'Sita Krishnan', initials: 'SK', role: 'Team Lead', department: 'AI/LLM & Perception', action: 'submitted daily work report', details: 'Marketing campaign analysis completed', timestamp: new Date(Date.now() - 1 * 86400000).toISOString() },
      ...
      { id: 10, type: 'report', name: 'John Doe', initials: 'JD', role: 'CEO', department: 'Founding Team', action: 'submitted weekly report', details: 'Q2 performance review and strategic planning', timestamp: new Date(Date.now() - 1 * 86400000).toISOString() },
      { id: 11, type: 'leave', name: 'John Doe', initials: 'JD', role: 'CEO', department: 'Founding Team', action: 'approved leave request', details: 'Anil Mehta - Annual Leave (5 days)', timestamp: new Date(Date.now() - 5 * 86400000).toISOString() },
