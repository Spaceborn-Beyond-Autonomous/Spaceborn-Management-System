...
const ActivityMonitor = ({ userRole = 'CEO' }) => {
  ...
  const getMockActivities = () => {
    return [
      { id: 1, type: 'report', name: 'Nisha Kumar', initials: 'NK', role: 'Member', department: 'Engineering', action: 'submitted daily work report', details: 'Completed UI component development and fixed navigation bugs', timestamp: new Date(Date.now() - 2 * 86400000).toISOString() },
      { id: 2, type: 'report', name: 'Anil Mehta', initials: 'AM', role: 'Team Lead', department: 'Design', action: 'submitted daily work report', details: 'Reviewed design system and updated component library', timestamp: new Date(Date.now() - 2 * 86400000).toISOString() },
      { id: 3, type: 'meeting', name: 'Sita Krishnan', initials: 'SK', role: 'Team Lead', department: 'Marketing', action: 'scheduled meeting', details: 'Marketing Campaign Kickoff - Tomorrow at 10 AM', timestamp: new Date(Date.now() - 2 * 86400000).toISOString() },
      { id: 4, type: 'leave', name: 'Jane Smith', initials: 'JS', role: 'Manager', department: 'Operations', action: 'approved leave request', details: 'Ravi Das - Sick Leave (2 days)', timestamp: new Date(Date.now() - 3 * 86400000).toISOString() },
      { id: 5, type: 'task', name: 'Mike Johnson', initials: 'MJ', role: 'Team Lead', department: 'Engineering', action: 'completed task', details: 'Code review for PR #123', timestamp: new Date(Date.now() - 3 * 86400000).toISOString() },
      { id: 6, type: 'pending', name: 'Ravi Das', initials: 'RD', role: 'Member', department: 'Engineering', action: 'applied for leave', details: 'Sick leave (2 days) - Pending approval', timestamp: new Date(Date.now() - 4 * 86400000).toISOString() },
      { id: 7, type: 'progress', name: 'Priya Sharma', initials: 'PS', role: 'Team Lead', department: 'Engineering', action: 'updated task progress', details: 'Build login UI - 75% complete', timestamp: new Date(Date.now() - 1 * 86400000).toISOString() },
      { id: 8, type: 'report', name: 'Sita Krishnan', initials: 'SK', role: 'Team Lead', department: 'Marketing', action: 'submitted daily work report', details: 'Marketing campaign analysis completed', timestamp: new Date(Date.now() - 1 * 86400000).toISOString() },
      { id: 9, type: 'task', name: 'Alex Chen', initials: 'AC', role: 'Member', department: 'Engineering', action: 'completed task', details: 'Fix navigation bug in header', timestamp: new Date(Date.now() - 5 * 86400000).toISOString() },
      { id: 10, type: 'report', name: 'John Doe', initials: 'JD', role: 'CEO', department: 'Executive', action: 'submitted weekly report', details: 'Q2 performance review and strategic planning', timestamp: new Date(Date.now() - 1 * 86400000).toISOString() },
      { id: 11, type: 'leave', name: 'John Doe', initials: 'JD', role: 'CEO', department: 'Executive', action: 'approved leave request', details: 'Anil Mehta - Annual Leave (5 days)', timestamp: new Date(Date.now() - 5 * 86400000).toISOString() },
      { id: 12, type: 'task', name: 'Nisha Kumar', initials: 'NK', role: 'Member', department: 'Engineering', action: 'started new task', details: 'Implement authentication module', timestamp: new Date(Date.now() - 6 * 86400000).toISOString() }
    ];
  };
