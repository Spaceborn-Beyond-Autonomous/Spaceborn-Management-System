// src/components/Dashboard/Manager/AttendanceView.jsx
import React, { useState, useEffect } from 'react';
import authService from '../../../services/authService';
import attendanceService from '../../../services/attendanceService';

const AttendanceView = ({ userRole = 'Manager' }) => {
              ...
              {liveStatus.map((employee) => (
                <div key={employee.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  {employee.currentTask && (
                    <span className="text-xs text-gray-400 truncate max-w-[150px]">{employee.currentTask}</span>
                  )}
                </div>
              ))}
            </div>
              ...
              <div className="p-4">
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  ...
                  <div className="text-center p-3 bg-purple-50 rounded-lg">
                    <p className="text-xl font-bold text-purple-600">{dept.workingFromHome || 0}</p>
