// src/components/Dashboard/Manager/ActivityMonitor.jsx
...
const ActivityMonitor = ({ userRole = 'Manager' }) => {
  ...
  useEffect(() => {
    applyFilters();
  }, [activities, filter, dateRange, searchTerm, selectedDepartment]);
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Team Activity Report');
    
    const fileName = `team-activity-${new Date().toISOString().split('T')[0]}.xlsx`;
    ...
    return (
      <div className="flex justify-center items-center h-96">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-500">Loading team activities...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Team Activity Monitor</h1>
        <p className="text-gray-500 mt-1">Track your team's activities across the platform</p>
        {useMockData && (
          <div className="mt-2 inline-flex items-center px-2 py-1 bg-yellow-100 text-yellow-700 text-xs rounded-full">
            Demo Mode - Viewing Team Activities
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-lg border p-4">
          ...
          <div className="text-sm text-gray-500">Team Activities</div>
        </div>
        <div className="bg-white rounded-lg border p-4">
      ...
      {error && filteredActivities.length === 0 ? (
        <div className="bg-white rounded-lg border border-red-200 p-8 text-center">
          ...
          <button onClick={fetchActivities} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Try Again</button>
        </div>
        ...
        <div className="bg-white rounded-lg border overflow-hidden">
          <div className="px-6 py-3 border-b bg-gray-50">
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-500">{filteredActivities.length} team activities found</span>
              ...
              <div key={activity.id} className="px-6 py-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {/* Additional context for managers */}
      ...
      <div className="mt-6 bg-blue-50 rounded-lg border border-blue-200 p-4">
        <h3 className="text-sm font-semibold text-blue-800 mb-2">Quick Actions</h3>
        <div className="flex gap-3">
          <button className="px-3 py-1.5 bg-white text-blue-600 rounded-lg text-sm border border-blue-200 hover:bg-blue-50">
