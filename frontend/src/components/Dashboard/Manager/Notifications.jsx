              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">
                    Notifications 
                    <span className="text-sm text-purple-600 ml-2">({userRole} View)</span>
                  </h1>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-slide-up">
            ...
            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center">
              <div className="flex items-center space-x-3">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg ${getCategoryColor(selectedNotification.category)}`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white border border-gray-200 rounded-xl divide-y divide-gray-100">
                    {Object.entries(selectedNotification.details).map(([key, value]) => (
                      <div key={key} className="flex items-start p-3 hover:bg-gray-50 transition-colors">
                        <span className="font-medium text-gray-600 min-w-[130px] text-sm capitalize">
